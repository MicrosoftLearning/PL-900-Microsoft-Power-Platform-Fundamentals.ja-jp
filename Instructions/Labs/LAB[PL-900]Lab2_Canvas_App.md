...
1.  **[Excel ファイルのアップロード]** 画面で、**[デバイスから選択]** ボタンを選択します。
...
1.  **[+ 挿入]** ドロップダウン メニューを選択してから、**[テキスト ラベル]** を選択します。
...
12. フォームの下部にある **[フッター]** を選択します。
1.  **[+ 挿入]** を選択し、**[ボタン]** を選択します。
