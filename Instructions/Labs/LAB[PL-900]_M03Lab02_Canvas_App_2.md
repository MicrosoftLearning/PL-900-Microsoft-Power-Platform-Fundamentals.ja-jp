...
2.  新しいキャンバス アプリケーションを作成します
    ...
    -   「**新規**」をクリックし、「**アプリ \| キャンバス アプリ**。

    -   空白のウィンドウのキャンバス アプリで、「アプリ名」フィールドに「**[Your Last Name] キャンパス セキュリティ**」を入力します。
...
3.  キャンバス アプリを保存します
    ...
    -   **クラウド**が選択されているかどうかを確認して、「**保存**」をクリックします。

    -   「名前」の「**[Your Last Name] キャンパス セキュリティ**」を確認して、「**保存**」をクリックします。
