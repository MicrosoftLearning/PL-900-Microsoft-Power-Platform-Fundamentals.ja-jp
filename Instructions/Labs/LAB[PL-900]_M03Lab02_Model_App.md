...
- "Bellows 経費管理" という名前の新しいモデル駆動型アプリを作成する
...
1. 左上の階層リンクを使用します (**[テーブル]** > **[経費精算書]** > **[フォーム]**)。 **[経費精算書]** を選択して、**[訪問]** テーブルのプロパティ画面に戻ります。

## タスク #2:[アクティブな訪問] ビューを編集する

このタスクでは、既定のアクティブな経費精算書ビューを変更し、今日の訪問の新しいビューを作成します。
...
1. **[並べ替え...]** の下の [X] を選択して **[名前]** を削除し、**[レポートの合計金額]** を選択します。

1. **[レポートの合計金額]** を選択して、並べ替え順序を **[大きい順]** に変更します。

1. 右上の **[保存して公開]** ボタンを選択し、公開が完了するまで待ちます。

### タスク #3:今日が期限のレポートの新しいビューを作成する
...
1. モデル駆動型アプリケーションを作成します。
    ...
    - **[名前]** に「従業員の経費管理」と入力し、**[作成]** を選択します。

1. 新しいモデル駆動型アプリケーションが読み込まれたら、**[+ ページの追加]** ボタンを選択します。

1. **[ページの追加]** 画面で、 **[Dataverse テーブル]** を選択し、 **[次へ]** ボタンを選択します。
...
1. 画面の右側にある **[表示オプション]** セクションで、**[タイトル]** プロパティを [レポート] に変更します。
...
1. **保存 &amp; 閉じる** を選択します。 これにより訪問が作成され、**アクティブな訪問**ビューに表示されるようになります。

1. **[アクティブな訪問]** の横にあるドロップダウンを使用して、ビューを **[今日が期限の経費清算書]** に変更します。 
