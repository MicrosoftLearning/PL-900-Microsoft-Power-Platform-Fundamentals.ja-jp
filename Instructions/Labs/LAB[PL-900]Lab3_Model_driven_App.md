...
1.  アプリに **Contoso Facilities Management** という名前を付けます。
1.  **［作成］** を選択します 最新のアプリ デザイナーが開きます。

## タスク 2: Facility Request テーブルを追加する

1.  **アプリ デザイナー**で、**[+ ページの追加]** または **[+ 新規]** を選択して、**[Dataverse テーブル]** を選択します。
1.  **[施設要求]** と **[部屋]** テーブルの両方を検索して選び (ラボ 1 が完了済みの場合)、さらに **[アカウント]** と **[連絡先]** テーブルを選択します。
...
1.  画面の左側にある**アプリ デザイナー**で、**[ページ]** を選択します。 **[ナビゲーション]** セクションで **[新しいグループ]** を選択します。

    ![[新しいグループ] のスクリーンショット](media/New-group.png)

1.  画面の右側で **[新しいグループ]** ペインがまだ展開されていない場合は展開します。
1.  **[タイトル]** を **[新しいグループ]** から **[顧客]** に変更します。
1.  **[顧客]** グループの横にある **3 つのドット**を選択して、次に **[新しいグループ]** を選択します。
1.  **[新しいグループ]** の **[名前]** を **[施設]** に変更します。
1.  **[ナビゲーション]** で **[施設要求]** ビューを選び、**[施設グループ]** になるまで **[下に移動]** を選びます。
1.  **部屋ビュー**に対しても、同じ作業を繰り返して、**[部屋]** が **[施設要求]** の下に表示されるまで、**[下へ移動]** を選択します。
1.  **[保存]** ボタンを選択します。
...
1.  右上の **[保存して公開]** を選択します。
1.  **[再生]** を選択して、新しいブラウザー タブでアプリを開きます。
1.  次の点を確認します。
    -   ナビゲーション メニューに **[施設要求]** テーブルが表示されます。
    -   テーブル名を選択すると、構成した列を含むリスト ビューが表示されます。
    -   レコードを選択すると、カスタマイズしたレイアウトを含むフォームが開きます。
    -   **[+ 新規]** を選択すると、新しいレコードを作成できます。
****
