...
lab:
  ...
  description: この演習では、学習者は Copilot を使用し、Power Apps でモデル駆動型アプリを作成します。 データ モデルを定義し、フォームとビューを変更し、アプリケーションを作成します。
  duration: 15 minutes
  level: 100
  islab: true
  primarytopics:
...
1. フォームの**コマンド バー**で、**[保存して発行]** ボタンを選択します。
